...
export default function Header() {
    ...
    const { activeSection, setActiveSection, setTimeOfLastClick } = useActiveSectionContext();    return(
        
        <header className='z-[999] relative'>
            <motion.div className='fixed top-0 left-1/2 -translate-x-1/2 h-[6rem] w-full rounded-none border border-white 
            border-opacity-40 bg-white shadow-lg 
            ...
            sm:top-[1.7rem] sm:h-[initial] sm:py-0'>
                <ul className='flex w-[22re flex-wrap items-center justify-center gap-y-1
